type FooterProps = {
  ...
  export const Footer = ({ setRegisterPageOpen }: FooterProps) => {
    return (
      <footer className="px-5 pt-6 flex flex-col justify-center items-center gap-6 text-center bg-fuchsia-600 bg-[url('https://www.premierleague.com/resources/prod/v6.122.4-6039/i/bg-elements/heading-bg-desktop.svg')] bg-no-repeat bg-right bg-cover">
